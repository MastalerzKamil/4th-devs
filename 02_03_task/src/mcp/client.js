 ...
 */
export async function createMcpClient(serverName = "failure-logs") {
  ...
  const client = new Client(
    { name: "failure-agent-client", version: "1.0.0" },
    { capabilities: {} }
  );
...
/**
 * List all tools from the MCP server and convert to OpenAI function-calling format.
 */
